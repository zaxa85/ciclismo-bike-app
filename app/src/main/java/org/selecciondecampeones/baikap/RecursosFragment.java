 ...
 * {@link RecursosFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RecursosFragment#newInstance} factory method to
...
public class RecursosFragment extends Fragment {
    ...
    public static RecursosFragment newInstance(String param1, String param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RestClient.get("/api/member", rp, new JsonHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray timeline) {
                ...
                try {
                    for (int i = 0; i < timeline.length(); i++) {
                        ...
                        actor = timeline.getJSONObject(i);

                        String firstname = null;
                        try {
                            firstname = actor.getString("firstname");
